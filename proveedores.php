                ...
                <div class="container-fluid">
                    ...
                    <?php
                      ...
                      echo "<div class='table-responsive'>
                        ...
                        echo "<td>
                        <a href='proveedor/editar.php?idperson={$datos['idperson']}' class='btn btn-info'> <i class='fas fa-edit ' style='size:5x'></i> </a>
                        <a href='proveedor/eliminar.php?idperson={$datos['idperson']}' onclick='return confirm(\"¿Está seguro de eliminar este Proveedor?\")' class='btn btn-danger'> <i class='fas fa-trash-alt'></i> </a>
                       </td>";
