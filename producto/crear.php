...
<head>
    ...
    <title>HSI - Crear Producto</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
										...
										<a href="../productos.php" class="btn btn-danger float-right"><i class="fas fa-window-close"></i> Cancelar</a>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                        <select name="categoryid" class="form-control form-select-user text-gray-600" id="ejemploCategory">
                                          ...
                                          <div class="col-sm-4 mb-3 mb-sm-0">
  																			      <a href="../productos.php" class="btn btn-primary btn-user btn-block"><i class="fas fa-plus"></i> Crear Producto</a>
  																	      </div>
																</div>
