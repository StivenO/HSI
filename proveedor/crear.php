...
<head>
    ...
    <title>HSI - Crear Proveedor</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
										...
										<a href="../proveedores.php" class="btn btn-danger float-right"><i class="fas fa-window-close"></i> Cancelar</a>
											...
											<div class="col-lg-6 mb-4">
													...
													<div class="card shadow mb-4" style="width: 60rem;">
															<div class="card-header py-3">
																	<h6 class="m-0 font-weight-bold text-primary text-center">Formulario para Proveedores</h6>
															</div>
															<div class="card-body">
